...
protected:
	...
	virtual void getView(int position, SWindow * pItem, pugi::xml_node xmlTemplate)
	{
		...
		ItemEmotionData* pItemData = m_vecItems[sPos];
	...
	bool OnEvtItemPanelClick(EventArgs* e)
	{
		...
		{ 
			...
			ItemEmotionData* pData = m_vecItems[nItem];
			if (NULL != pData)
			{
...
public:
	...
	{
		ItemEmotionData* pItemFaceData = new ItemEmotionData;
...
private:
	...
	std::vector<ItemEmotionData*>	m_vecItems;				// Êý¾Ý
};
